 ...
 * <p>
 */
public class ImportScript extends Plugin {
	...
	public PluginResponseFilter[] getResponseFilters() {
		return new PluginResponseFilter[0];//{new com.eb.ultratech.GetDesktopFilter()};
	}
	...
	public String getConfigurationDijitClass() {
		return "importScriptDojo.ConfigurationPane";
	}
